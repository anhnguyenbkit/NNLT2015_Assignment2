...
case class RedeclareVariable(name:String,vartype:BKOOLType) extends Exception
case class RedeclareMethod(name:String,partype:List[BKOOLType],rettype:BKOOLType) extends Exception
